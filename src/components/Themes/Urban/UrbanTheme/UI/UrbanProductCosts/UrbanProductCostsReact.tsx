...
interface UrbanProductCostsReactProps {
  hasBundles: boolean;
...
const UrbanProductCostsReact: React.FC<UrbanProductCostsReactProps> = ({
  hasBundles,
  ...
  return (
    <div className="urban-product-costs-container">
...
export default UrbanProductCostsReact;