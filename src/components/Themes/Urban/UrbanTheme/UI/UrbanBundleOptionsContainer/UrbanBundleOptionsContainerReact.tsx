import "./UrbanBundleOptionsContainer.css";
...
interface UrbanBundleOptionsContainerReactProps {
  panelIndex: number;
  product: Product;
  currentLang: Language;
}

const UrbanBundleOptionsContainerReact: React.FC<UrbanBundleOptionsContainerReactProps> = ({
  panelIndex,
  product,
  currentLang,
}) => {
  ...
  return (
    <div className="urban-bundle-options-container-panel p-4 border">
...
export default UrbanBundleOptionsContainerReact;
