// UrbanConfirmPurchaseButtonReact.tsx
import "./UrbanConfirmPurchaseButton.css";
...
interface UrbanConfirmPurchaseButtonReactProps {
  isArabic: boolean;
...
const UrbanConfirmPurchaseButtonReact: React.FC<UrbanConfirmPurchaseButtonReactProps> = ({
  disabled,
  isArabic,
  onClick,
  confirmTextOverride,
  ...
  return (
    <button
      type="button"
      className={`urban-modal-confirm ${isLoading ? 'loading' : ''}`}
      onClick={handleClick}
      disabled={isLoading}
      aria-busy={isLoading}
    >
...
export default UrbanConfirmPurchaseButtonReact;