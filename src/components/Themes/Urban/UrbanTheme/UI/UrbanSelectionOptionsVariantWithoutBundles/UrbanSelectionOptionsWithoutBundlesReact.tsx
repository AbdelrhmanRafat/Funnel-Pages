...
interface UrbanSelectionOptionsWithoutBundlesReactProps {
...
const UrbanSelectionOptionsWithoutBundlesReact: React.FC<UrbanSelectionOptionsWithoutBundlesReactProps> = ({
  isHaveVariant,
  hasSecondOption,
  processedOptionData,
  qtyNonVariant,
  ...
  return (
    <div className="urban-selection-options-without-bundles w-full">
      <section id="urban-selection-options-without-bundles-section">
...
export default UrbanSelectionOptionsWithoutBundlesReact;
