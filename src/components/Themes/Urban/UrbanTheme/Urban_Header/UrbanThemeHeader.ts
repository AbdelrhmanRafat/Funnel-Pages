// UrbanThemeHeader.ts - Simplified Header with Mobile Navigation
...
class UrbanThemeHeader {
  ...
  private initializeElements(): HeaderElements {
    return {
      header: document.querySelector('.urban-header') as HTMLElement | null,
      ...
      menuLinks: document.querySelectorAll('.urban-menu-link')
    };
  }
