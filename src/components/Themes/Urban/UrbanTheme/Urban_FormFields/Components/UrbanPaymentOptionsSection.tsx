...
interface UrbanPaymentOptionsSectionProps {
  paymentOptions: PaymentOption[];
  currentLang: Language;
}

const UrbanPaymentOptionsSection: React.FC<UrbanPaymentOptionsSectionProps> = ({
  paymentOptions,
  currentLang,
}) => {
  // Payment store hook
...
export default UrbanPaymentOptionsSection;