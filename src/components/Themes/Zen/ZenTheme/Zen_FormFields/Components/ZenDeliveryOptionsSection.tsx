...
interface ZenDeliveryOptionsSectionProps {
  deliveryOptions: DeliveryOption[];
  currentLang: Language;
}

const ZenDeliveryOptionsSection: React.FC<ZenDeliveryOptionsSectionProps> = ({
  deliveryOptions,
  currentLang,
}) => {
  // Delivery store hook
...
export default ZenDeliveryOptionsSection;