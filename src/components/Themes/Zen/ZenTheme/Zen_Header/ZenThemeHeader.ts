// ZenThemeHeader.ts - Simplified Header with Mobile Navigation
...
class ZenThemeHeader {
  ...
  private initializeElements(): HeaderElements {
    return {
      header: document.querySelector('.zen-header') as HTMLElement | null,
      ...
      menuLinks: document.querySelectorAll('.zen-menu-link')
    };
  }
