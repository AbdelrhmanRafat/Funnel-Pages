...
interface ZenSelectionOptionsWithoutBundlesReactProps {
...
const ZenSelectionOptionsWithoutBundlesReact: React.FC<ZenSelectionOptionsWithoutBundlesReactProps> = ({
  isHaveVariant,
  hasSecondOption,
  processedOptionData,
  qtyNonVariant,
  ...
  return (
    <div className="zen-selection-options-without-bundles w-full">
      <section id="zen-selection-options-without-bundles-section">
...
export default ZenSelectionOptionsWithoutBundlesReact;
