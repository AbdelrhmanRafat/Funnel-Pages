import "./ZenBundleOptionsContainer.css";
...
interface ZenBundleOptionsContainerReactProps {
  panelIndex: number;
  product: Product;
  currentLang: Language;
}

const ZenBundleOptionsContainerReact: React.FC<ZenBundleOptionsContainerReactProps> = ({
  panelIndex,
  product,
  currentLang,
}) => {
  ...
  return (
    <div className="zen-bundle-options-container-panel p-4 border">
...
export default ZenBundleOptionsContainerReact;
