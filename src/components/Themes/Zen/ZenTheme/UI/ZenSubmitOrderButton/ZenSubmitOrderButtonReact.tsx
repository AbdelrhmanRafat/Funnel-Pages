import "./ZenSubmitOrderButton.css";
import React, { useState } from 'react';
import type { Language } from '../../../../../../lib/utils/i18n/translations';
import type { BlockData, Product } from '../../../../../../lib/api/types';
import ZenModalPurchaseInfoReact from '../../ZenModalPurchaseInfo/ZenModalPurchaseInfoReact';
...
interface ZenSubmitOrderButtonReactProps {
...
const ZenSubmitOrderButtonReact: React.FC<ZenSubmitOrderButtonReactProps> = ({
  product,
  purchaseOptions,
  isHaveVariant,
  currentLang = "en",
  ...
  return (
    <>
      <div className="zen-form-submit-wrapper">
...
export default ZenSubmitOrderButtonReact;