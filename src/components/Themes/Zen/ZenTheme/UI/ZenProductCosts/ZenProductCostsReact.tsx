...
interface ZenProductCostsReactProps {
  hasBundles: boolean;
...
const ZenProductCostsReact: React.FC<ZenProductCostsReactProps> = ({
  hasBundles,
  ...
  return (
    <div className="zen-product-costs-container">
...
export default ZenProductCostsReact;