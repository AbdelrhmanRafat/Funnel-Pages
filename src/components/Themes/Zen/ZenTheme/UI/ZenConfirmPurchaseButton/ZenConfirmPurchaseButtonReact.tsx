// ZenConfirmPurchaseButtonReact.tsx
import "./ZenConfirmPurchaseButton.css";
...
interface ZenConfirmPurchaseButtonReactProps {
  isArabic: boolean;
...
const ZenConfirmPurchaseButtonReact: React.FC<ZenConfirmPurchaseButtonReactProps> = ({
  disabled,
  isArabic,
  onClick,
  confirmTextOverride,
  ...
  return (
    <button
      type="button"
      className={`zen-modal-confirm ${isLoading ? 'loading' : ''}`}
      onClick={handleClick}
      disabled={isLoading}
      aria-busy={isLoading}
    >
...
export default ZenConfirmPurchaseButtonReact;