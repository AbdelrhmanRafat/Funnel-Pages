...
import './ZenThemeRates.css';

interface ZenThemeRatesReactProps {
...
const ZenThemeRatesReact: React.FC<ZenThemeRatesReactProps> = ({
  ratingData,
  currentLang,
}) => {
  ...
  const StarIcon: React.FC<{ star: Star }> = ({ star }) => {
    ...
    switch (star.type) {
      case 'full':
        return (
          <svg className="zen-rating-star-full" {...baseProps}>
      ...
      case 'half':
        return (
          <svg className="zen-rating-star-half" {...baseProps}>
            <defs>
              <linearGradient id="halfGradient">
                <stop offset="50%" stopColor="currentColor" />
                <stop offset="50%" stopColor="var(--zen-color-outline)" />
              </linearGradient>
            </defs>
      ...
      case 'empty':
        return (
          <svg className="zen-rating-star-empty" {...baseProps}>
            <path d={starPath} fill="currentColor" />
          </svg>
        );
  ...
  return (
    <div id={FunnelZenComponents.ZenRates} className="zen-rates">
      <div
        className="zen-rating-display"
      ...
      >
        ...
        <span className="zen-rating-number">({rating})</span>
      </div>
    </div>
  );
};

export default ZenThemeRatesReact;