import "./MinimalBundleOptionsContainer.css";
...
interface MinimalBundleOptionsContainerReactProps {
  panelIndex: number;
  product: Product;
  currentLang: Language;
}

const MinimalBundleOptionsContainerReact: React.FC<MinimalBundleOptionsContainerReactProps> = ({
  panelIndex,
  product,
  currentLang,
}) => {
  ...
  return (
    <div className="minimal-bundle-options-container-panel p-4 border">
...
export default MinimalBundleOptionsContainerReact;
