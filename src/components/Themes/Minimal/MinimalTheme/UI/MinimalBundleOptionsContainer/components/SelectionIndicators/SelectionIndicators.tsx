...
const SelectionIndicators: React.FC<SelectionIndicatorsProps> = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
      {firstOption && (
        <div className="minimal-bundle-options-container-selection-indicator flex items-center gap-1 justify-center sm:justify-start py-1 px-3 rounded-full text-xs sm:text-sm">
