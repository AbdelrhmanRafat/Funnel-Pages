...
interface MinimalProductCostsReactProps {
  hasBundles: boolean;
...
const MinimalProductCostsReact: React.FC<MinimalProductCostsReactProps> = ({
  hasBundles,
  ...
  return (
    <div className="minimal-product-costs-container">
...
export default MinimalProductCostsReact;