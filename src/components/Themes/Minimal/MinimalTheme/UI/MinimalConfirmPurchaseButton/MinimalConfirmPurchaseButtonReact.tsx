// MinimalConfirmPurchaseButtonReact.tsx
import "./MinimalConfirmPurchaseButton.css";
...
interface MinimalConfirmPurchaseButtonReactProps {
  isArabic: boolean;
...
const MinimalConfirmPurchaseButtonReact: React.FC<MinimalConfirmPurchaseButtonReactProps> = ({
  disabled,
  isArabic,
  onClick,
  confirmTextOverride,
  ...
  return (
    <button
      type="button"
      className={`minimal-modal-confirm ${isLoading ? 'loading' : ''}`}
      onClick={handleClick}
      disabled={isLoading}
      aria-busy={isLoading}
    >
...
export default MinimalConfirmPurchaseButtonReact;