...
interface MinimalPersonalInfoSectionProps {
  cities: string[];
  currentLang: Language;
}

const MinimalPersonalInfoSection: React.FC<MinimalPersonalInfoSectionProps> = ({
  cities,
  currentLang,
}) => {
  // Form store hooks
    ...
    <>
      ...
      <div className="w-full">
        <div className='mb-3'>
          ...
          <h2
            className="minimal-form-h2-title mb-6 text-xl font-semibold md:text-2xl"
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="minimal-form-div-group">
              <input
                type="text"
                id="form-fullName"
                ...
                className={`minimal-form-input-base minimal-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  fullNameField.touched && fullNameField.errorMessage ? 'minimal-form-input-error' : 
                  fullNameField.touched && fullNameField.isValid ? 'minimal-form-input-success' : ''
                }`}
              ...
              <label
                ...
                className="minimal-form-label-floating"
              ...
              <span
                ...
                className="minimal-form-span-error text-xs md:text-sm"
                role="alert"
            ...
            <div className="minimal-form-div-group">
              <input
                ...
                className={`minimal-form-input-base minimal-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  phoneField.touched && phoneField.errorMessage ? 'minimal-form-input-error' : 
                  phoneField.touched && phoneField.isValid ? 'minimal-form-input-success' : ''
                }`}
            ...
            <div className="minimal-form-div-group">
              <input
                ...
                className={`minimal-form-input-base minimal-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  emailField.touched && emailField.errorMessage ? 'minimal-form-input-error' : 
                  emailField.touched && emailField.isValid ? 'minimal-form-input-success' : ''
                }`}
            ...
            <div className="minimal-form-div-group">
              <textarea
                ...
                className={`minimal-form-input-base minimal-form-textarea-responsive ${isArabic ? "text-right" : "text-left"} min-h-[80px] md:min-h-[100px] resize-y text-sm md:text-base ${
                  addressField.touched && addressField.errorMessage ? 'minimal-form-input-error' : 
                  addressField.touched && addressField.isValid ? 'minimal-form-input-success' : ''
                }`}
            ...
            <div className="minimal-form-div-group">
              <select 
                ...
                className={`minimal-form-select-base minimal-form-select-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  cityField.touched && cityField.errorMessage ? 'minimal-form-input-error' : 
                  cityField.touched && cityField.isValid ? 'minimal-form-input-success' : ''
                }`}
...
export default MinimalPersonalInfoSection;