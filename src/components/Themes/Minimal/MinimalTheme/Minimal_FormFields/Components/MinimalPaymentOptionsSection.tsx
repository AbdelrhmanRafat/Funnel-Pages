...
interface MinimalPaymentOptionsSectionProps {
  paymentOptions: PaymentOption[];
  currentLang: Language;
}

const MinimalPaymentOptionsSection: React.FC<MinimalPaymentOptionsSectionProps> = ({
  paymentOptions,
  currentLang,
}) => {
  // Payment store hook
...
export default MinimalPaymentOptionsSection;