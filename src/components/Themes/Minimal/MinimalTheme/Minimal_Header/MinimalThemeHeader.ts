// MinimalThemeHeader.ts - Simplified Header with Mobile Navigation
...
class MinimalThemeHeader {
  ...
  private initializeElements(): HeaderElements {
    return {
      header: document.querySelector('.minimal-header') as HTMLElement | null,
      ...
      menuLinks: document.querySelectorAll('.minimal-menu-link')
    };
  }
