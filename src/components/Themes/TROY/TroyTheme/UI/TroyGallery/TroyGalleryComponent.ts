// TroyGalleryController.ts
export class TroyGalleryController {
    ...
    constructor(galleryId: string = 'troy-gallery') {
        this.init(galleryId);
    }
    ...
    private setupGallery(galleryId: string): void {
        ...
        this.thumbnails = this.gallery.querySelectorAll('.troy-thumbnail');
...
let galleryController: TroyGalleryController;

// Auto-initialize
document.addEventListener('DOMContentLoaded', () => {
    galleryController = new TroyGalleryController();
