...
const FORM_FIELD_CONFIG = {
  ...
  ERROR_CLASSES: {
    INVALID: 'troy-border-error',
    VALID: 'troy-border-success',
    ERROR_CONTAINER: 'troy-error-container',
    ERROR_MESSAGE: 'troy-error-message'
  }
} as const;

/**
 * TroyFormValidator - Handles form validation with real-time feedback
 * Supports multilingual validation messages and color/size option validation
 */
class TroyFormValidator {
