...
import './ProThemeRates.css';

interface ProThemeRatesReactProps {
...
const ProThemeRatesReact: React.FC<ProThemeRatesReactProps> = ({
  ratingData,
  currentLang,
}) => {
  ...
  const StarIcon: React.FC<{ star: Star }> = ({ star }) => {
    ...
    switch (star.type) {
      case 'full':
        return (
          <svg className="pro-rating-star-full" {...baseProps}>
      ...
      case 'half':
        return (
          <svg className="pro-rating-star-half" {...baseProps}>
            <defs>
              <linearGradient id="halfGradient">
                <stop offset="50%" stopColor="currentColor" />
                <stop offset="50%" stopColor="var(--pro-color-outline)" />
              </linearGradient>
            </defs>
      ...
      case 'empty':
        return (
          <svg className="pro-rating-star-empty" {...baseProps}>
            <path d={starPath} fill="currentColor" />
          </svg>
        );
  ...
  return (
    <div id={FunnelProComponents.ProRates} className="pro-rates">
      <div
        className="pro-rating-display"
      ...
      >
        ...
        <span className="pro-rating-number">({rating})</span>
      </div>
    </div>
  );
};

export default ProThemeRatesReact;