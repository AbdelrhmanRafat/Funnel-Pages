...
interface ProPersonalInfoSectionProps {
  cities: string[];
  currentLang: Language;
}

const ProPersonalInfoSection: React.FC<ProPersonalInfoSectionProps> = ({
  cities,
  currentLang,
}) => {
  // Form store hooks
    ...
    <>
      ...
      <div className="w-full">
        <div className='mb-3'>
          ...
          <h2
            className="pro-form-h2-title mb-6 text-xl font-semibold md:text-2xl"
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="pro-form-div-group">
              <input
                type="text"
                id="form-fullName"
                ...
                className={`pro-form-input-base pro-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  fullNameField.touched && fullNameField.errorMessage ? 'pro-form-input-error' : 
                  fullNameField.touched && fullNameField.isValid ? 'pro-form-input-success' : ''
                }`}
              ...
              <label
                ...
                className="pro-form-label-floating"
              ...
              <span
                ...
                className="pro-form-span-error text-xs md:text-sm"
                role="alert"
            ...
            <div className="pro-form-div-group">
              <input
                ...
                className={`pro-form-input-base pro-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  phoneField.touched && phoneField.errorMessage ? 'pro-form-input-error' : 
                  phoneField.touched && phoneField.isValid ? 'pro-form-input-success' : ''
                }`}
            ...
            <div className="pro-form-div-group">
              <input
                ...
                className={`pro-form-input-base pro-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  emailField.touched && emailField.errorMessage ? 'pro-form-input-error' : 
                  emailField.touched && emailField.isValid ? 'pro-form-input-success' : ''
                }`}
            ...
            <div className="pro-form-div-group">
              <textarea
                ...
                className={`pro-form-input-base pro-form-textarea-responsive ${isArabic ? "text-right" : "text-left"} min-h-[80px] md:min-h-[100px] resize-y text-sm md:text-base ${
                  addressField.touched && addressField.errorMessage ? 'pro-form-input-error' : 
                  addressField.touched && addressField.isValid ? 'pro-form-input-success' : ''
                }`}
            ...
            <div className="pro-form-div-group">
              <select 
                ...
                className={`pro-form-select-base pro-form-select-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  cityField.touched && cityField.errorMessage ? 'pro-form-input-error' : 
                  cityField.touched && cityField.isValid ? 'pro-form-input-success' : ''
                }`}
...
export default ProPersonalInfoSection;