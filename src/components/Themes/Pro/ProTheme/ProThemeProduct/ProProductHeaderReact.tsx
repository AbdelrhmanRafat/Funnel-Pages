...
import ProThemeRatesReact from '../ProThemeRates/ProThemeRatesReact';

interface ProProductHeaderReactProps {
  product: Product;
...
const ProProductHeaderReact: React.FC<ProProductHeaderReactProps> = ({
  product,
  purchaseOptions,
  isHaveVariant,
  currentLang,
    ...
    <div className="w-full flex flex-col justify-start items-start gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span
          className={`${
            product.is_active
              ? "pro-product-details-badge-success text-xs py-1 px-3 rounded-full font-medium"
              : "pro-product-details-badge-error text-xs py-1 px-3 rounded-full font-medium"
          }`}
          data-translate={
            product.is_active
              ? "product.available"
        ...
        {showSku && (
          <div className="pro-product-details-sku text-sm">
      ...
      <div className="w-full flex justify-start items-center gap-4">
        <h2 className="pro-product-details-title text-3xl lg:text-4xl font-bold leading-tight">
      ...
      <div className="flex justify-start items-center gap-4">
        ...
        <div className="pro-product-details-price pro-product-details-price--discount flex justify-center line-through items-center gap-2 text-4xl font-bold">
          <span data-product-price>{headerState.currentPrice}</span>
        </div>
        
        {/* Discounted Price */}
        <div className="pro-product-details-price flex justify-center items-center gap-2 text-4xl font-bold">
...
export default ProProductHeaderReact;