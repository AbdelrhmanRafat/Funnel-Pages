import "./ProBundleOptionsContainer.css";
...
interface ProBundleOptionsContainerReactProps {
  panelIndex: number;
  product: Product;
  currentLang: Language;
}

const ProBundleOptionsContainerReact: React.FC<ProBundleOptionsContainerReactProps> = ({
  panelIndex,
  product,
  currentLang,
}) => {
  ...
  return (
    <div className="pro-bundle-options-container-panel p-4 border">
...
export default ProBundleOptionsContainerReact;
