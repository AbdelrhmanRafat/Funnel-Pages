// ProConfirmPurchaseButtonReact.tsx
import "./ProConfirmPurchaseButton.css";
...
interface ProConfirmPurchaseButtonReactProps {
  isArabic: boolean;
...
const ProConfirmPurchaseButtonReact: React.FC<ProConfirmPurchaseButtonReactProps> = ({
  disabled,
  isArabic,
  onClick,
  confirmTextOverride,
  ...
  return (
    <button
      type="button"
      className={`pro-modal-confirm ${isLoading ? 'loading' : ''}`}
      onClick={handleClick}
      disabled={isLoading}
      aria-busy={isLoading}
    >
...
export default ProConfirmPurchaseButtonReact;