// ProSelectionOptionsWithoutBundles.ts - Production Ready Component
...
const CSS_CLASSES = {
  SELECTED_COLOR: 'pro-selection-options-without-bundles-color-option--selected',
  SELECTED_SIZE: 'pro-selection-options-without-bundles-size-option--selected',
  SELECTED_GENERIC: 'pro-selection-options-without-bundles-selected',
  COLOR_OPTION: 'pro-selection-options-without-bundles-color-option',
  SIZE_OPTION: 'pro-selection-options-without-bundles-size-option',
  OPTION_AVAILABLE: 'pro-selection-options-without-bundles-option-available',
  OPTION_DISABLED: 'pro-selection-options-without-bundles-option-disabled'
} as const;

class ProSelectOptions extends HTMLElement implements Observer<CustomOptionsNonBundleState> {
  ...
  private initializeSettings(): void {
    try {
      ...
      console.error('ProSelectOptions: Failed to initialize settings:', error);
    }
  }
  ...
  public update(subject: Subject<CustomOptionsNonBundleState>): void {
    try {
      ...
      console.error('ProSelectOptions: Observer update failed:', error);
    }
  }
  ...
  private handleFirstOptionClick(element: HTMLElement): void {
    ...
    try {
      ...
      console.error('ProSelectOptions: First option selection failed:', error);
    }
  }
  ...
  private handleSecondOptionClick(element: HTMLElement): void {
    ...
    try {
      ...
      console.error('ProSelectOptions: Second option selection failed:', error);
    }
  }
  ...
  private handleQuantityDecrease(): void {
    try {
      ...
      console.error('ProSelectOptions: Quantity decrease failed:', error);
    }
  }
  ...
  private handleQuantityIncrease(): void {
    try {
      ...
      console.error('ProSelectOptions: Quantity increase failed:', error);
    }
  }
  ...
  private handleQuantityInput(): void {
    ...
    try {
      ...
      console.error('ProSelectOptions: Quantity input failed:', error);
    }
  }
  ...
  private validateQuantityInput(): void {
    ...
    try {
      ...
      console.error('ProSelectOptions: Quantity validation failed:', error);
    }
  }
  ...
  private applySelectionStyle(element: HTMLElement): void {
    try {
      ...
      console.error('ProSelectOptions: Failed to apply selection style:', error);
    }
  }
  ...
  private safeFilterSecondOptions(firstValue: string): void {
    ...
    try {
      ...
      console.error('ProSelectOptions: Failed to filter second options:', error);
    }
  }
  ...
  private toggleElementAvailability(element: HTMLElement, isAvailable: boolean): void {
    try {
      ...
      console.error('ProSelectOptions: Failed to toggle element availability:', error);
    }
  }
  ...
  private updateVisualSelections(option: any): void {
    try {
      ...
      console.error('ProSelectOptions: Failed to update visual selections:', error);
    }
  }
  ...
  private updateAvailableOptions(state: CustomOptionsNonBundleState): void {
    ...
    try {
      ...
      console.error('ProSelectOptions: Failed to update available options:', error);
    }
  }
  ...
  private updateQuantityControls(currentQty: number, maxQty: number): void {
    try {
      ...
      console.error('ProSelectOptions: Failed to update quantity controls:', error);
    }
  }
  ...
  private updateMaxQuantityDisplay(maxQty: number, isSelectionComplete: boolean): void {
    try {
      ...
      console.error('ProSelectOptions: Failed to update max quantity display:', error);
    }
  }
  ...
  public getSelectedOptions(): { first: string | null; second: string | null } {
    try {
      ...
      console.error('ProSelectOptions: Failed to get selected options:', error);
  ...
  public isSelectionComplete(): boolean {
    try {
      ...
      console.error('ProSelectOptions: Failed to check selection completion:', error);
      return false;
    }
  }
  ...
  public clearSelections(): void {
    try {
      ...
      console.error('ProSelectOptions: Failed to clear selections:', error);
    }
  }
  ...
  private resetSecondOptionsState(): void {
    ...
    try {
      ...
      console.error('ProSelectOptions: Failed to reset second options state:', error);
    }
  }
}

// Component Registration
class ProSelectOptionsManager {
  private static readonly COMPONENT_NAME = 'pro-select-options';
  ...
  private static registerComponent(): void {
    if (!customElements.get(this.COMPONENT_NAME)) {
      customElements.define(this.COMPONENT_NAME, ProSelectOptions);
    }
  }
  ...
  private static handleAstroPageLoad(): void {
    ...
    undefinedComponents.forEach(component => {
      if (component instanceof ProSelectOptions) {
...
ProSelectOptionsManager.initialize();

export { ProSelectOptions };