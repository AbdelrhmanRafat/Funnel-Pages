...
import ElegantThemeRatesReact from '../ElegantThemeRates/ElegantThemeRatesReact';

interface ElegantProductHeaderReactProps {
  product: Product;
...
const ElegantProductHeaderReact: React.FC<ElegantProductHeaderReactProps> = ({
  product,
  purchaseOptions,
  isHaveVariant,
  currentLang,
    ...
    <div className="w-full flex flex-col justify-start items-start gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span
          className={`${
            product.is_active
              ? "elegant-product-details-badge-success text-xs py-1 px-3 rounded-full font-medium"
              : "elegant-product-details-badge-error text-xs py-1 px-3 rounded-full font-medium"
          }`}
          data-translate={
            product.is_active
              ? "product.available"
        ...
        {showSku && (
          <div className="elegant-product-details-sku text-sm">
      ...
      <div className="w-full flex justify-start items-center gap-4">
        <h2 className="elegant-product-details-title text-3xl lg:text-4xl font-bold leading-tight">
          {isArabic ? product.name_ar : product.name_en}
        </h2>
        {ratingData && (
          <ElegantThemeRatesReact 
      ...
      <div className="flex justify-start items-center gap-4">
        ...
        <div className="elegant-product-details-price elegant-product-details-price--discount flex justify-center line-through items-center gap-2 text-4xl font-bold">
          <span data-product-price>{headerState.currentPrice}</span>
        </div>
        
        {/* Discounted Price */}
        <div className="elegant-product-details-price flex justify-center items-center gap-2 text-4xl font-bold">
...
export default ElegantProductHeaderReact;