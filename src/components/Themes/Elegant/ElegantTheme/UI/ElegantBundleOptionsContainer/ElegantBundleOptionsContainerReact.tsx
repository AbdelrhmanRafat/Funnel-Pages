...
interface ElegantBundleOptionsContainerReactProps {
  panelIndex: number;
  product: Product;
  currentLang: Language;
}

const ElegantBundleOptionsContainerReact: React.FC<ElegantBundleOptionsContainerReactProps> = ({
  panelIndex,
  product,
  currentLang,
}) => {
  ...
  return (
    <div className="elegant-bundle-options-container-panel p-4 border">
...
export default ElegantBundleOptionsContainerReact;
