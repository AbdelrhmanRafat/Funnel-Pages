// ElegantSelectionOptionsWithoutBundles.ts - Production Ready Component
...
const CSS_CLASSES = {
  SELECTED_COLOR: 'elegant-selection-options-without-bundles-color-option--selected',
  SELECTED_SIZE: 'elegant-selection-options-without-bundles-size-option--selected',
  SELECTED_GENERIC: 'elegant-selection-options-without-bundles-selected',
  COLOR_OPTION: 'elegant-selection-options-without-bundles-color-option',
  SIZE_OPTION: 'elegant-selection-options-without-bundles-size-option',
  OPTION_AVAILABLE: 'elegant-selection-options-without-bundles-option-available',
  OPTION_DISABLED: 'elegant-selection-options-without-bundles-option-disabled'
} as const;

class ElegantSelectOptions extends HTMLElement implements Observer<CustomOptionsNonBundleState> {
  ...
  private initializeSettings(): void {
    try {
      ...
      console.error('ElegantSelectOptions: Failed to initialize settings:', error);
    }
  }
  ...
  public update(subject: Subject<CustomOptionsNonBundleState>): void {
    try {
      ...
      console.error('ElegantSelectOptions: Observer update failed:', error);
    }
  }
  ...
  private handleFirstOptionClick(element: HTMLElement): void {
    ...
    try {
      ...
      console.error('ElegantSelectOptions: First option selection failed:', error);
    }
  }
  ...
  private handleSecondOptionClick(element: HTMLElement): void {
    ...
    try {
      ...
      console.error('ElegantSelectOptions: Second option selection failed:', error);
    }
  }
  ...
  private handleQuantityDecrease(): void {
    try {
      ...
      console.error('ElegantSelectOptions: Quantity decrease failed:', error);
    }
  }
  ...
  private handleQuantityIncrease(): void {
    try {
      ...
      console.error('ElegantSelectOptions: Quantity increase failed:', error);
    }
  }
  ...
  private handleQuantityInput(): void {
    ...
    try {
      ...
      console.error('ElegantSelectOptions: Quantity input failed:', error);
    }
  }
  ...
  private validateQuantityInput(): void {
    ...
    try {
      ...
      console.error('ElegantSelectOptions: Quantity validation failed:', error);
    }
  }
  ...
  private applySelectionStyle(element: HTMLElement): void {
    try {
      ...
      console.error('ElegantSelectOptions: Failed to apply selection style:', error);
    }
  }
  ...
  private safeFilterSecondOptions(firstValue: string): void {
    ...
    try {
      ...
      console.error('ElegantSelectOptions: Failed to filter second options:', error);
    }
  }
  ...
  private toggleElementAvailability(element: HTMLElement, isAvailable: boolean): void {
    try {
      ...
      console.error('ElegantSelectOptions: Failed to toggle element availability:', error);
    }
  }
  ...
  private updateVisualSelections(option: any): void {
    try {
      ...
      console.error('ElegantSelectOptions: Failed to update visual selections:', error);
    }
  }
  ...
  private updateAvailableOptions(state: CustomOptionsNonBundleState): void {
    ...
    try {
      ...
      console.error('ElegantSelectOptions: Failed to update available options:', error);
    }
  }
  ...
  private updateQuantityControls(currentQty: number, maxQty: number): void {
    try {
      ...
      console.error('ElegantSelectOptions: Failed to update quantity controls:', error);
    }
  }
  ...
  private updateMaxQuantityDisplay(maxQty: number, isSelectionComplete: boolean): void {
    try {
      ...
      console.error('ElegantSelectOptions: Failed to update max quantity display:', error);
    }
  }
  ...
  public getSelectedOptions(): { first: string | null; second: string | null } {
    try {
      ...
      console.error('ElegantSelectOptions: Failed to get selected options:', error);
  ...
  public isSelectionComplete(): boolean {
    try {
      ...
      console.error('ElegantSelectOptions: Failed to check selection completion:', error);
      return false;
    }
  }
  ...
  public clearSelections(): void {
    try {
      ...
      console.error('ElegantSelectOptions: Failed to clear selections:', error);
    }
  }
  ...
  private resetSecondOptionsState(): void {
    ...
    try {
      ...
      console.error('ElegantSelectOptions: Failed to reset second options state:', error);
    }
  }
}

// Component Registration
class ElegantSelectOptionsManager {
  private static readonly COMPONENT_NAME = 'elegant-select-options';
  ...
  private static registerComponent(): void {
    if (!customElements.get(this.COMPONENT_NAME)) {
      customElements.define(this.COMPONENT_NAME, ElegantSelectOptions);
    }
  }
  ...
  private static handleAstroPageLoad(): void {
    ...
    undefinedComponents.forEach(component => {
      if (component instanceof ElegantSelectOptions) {
...
ElegantSelectOptionsManager.initialize();

export { ElegantSelectOptions };