// ElegantConfirmPurchaseButtonReact.tsx
import "./ElegantConfirmPurchaseButton.css";
...
interface ElegantConfirmPurchaseButtonReactProps {
  isArabic: boolean;
...
const ElegantConfirmPurchaseButtonReact: React.FC<ElegantConfirmPurchaseButtonReactProps> = ({
  disabled,
  isArabic,
  onClick,
  confirmTextOverride,
  ...
  return (
    <button
      type="button"
      className={`elegant-modal-confirm ${isLoading ? 'loading' : ''}`}
      onClick={handleClick}
      disabled={isLoading}
      aria-busy={isLoading}
    >
...
export default ElegantConfirmPurchaseButtonReact;