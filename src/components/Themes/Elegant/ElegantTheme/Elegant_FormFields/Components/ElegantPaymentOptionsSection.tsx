...
interface ElegantPaymentOptionsSectionProps {
  paymentOptions: PaymentOption[];
  currentLang: Language;
}

const ElegantPaymentOptionsSection: React.FC<ElegantPaymentOptionsSectionProps> = ({
  paymentOptions,
  currentLang,
}) => {
  // Payment store hook
...
export default ElegantPaymentOptionsSection;