// ElegantThemeHeader.ts - Simplified Header with Mobile Navigation
...
class ElegantThemeHeader {
  ...
  private initializeElements(): HeaderElements {
    return {
      header: document.querySelector('.elegant-header') as HTMLElement | null,
      ...
      menuLinks: document.querySelectorAll('.elegant-menu-link')
    };
  }
