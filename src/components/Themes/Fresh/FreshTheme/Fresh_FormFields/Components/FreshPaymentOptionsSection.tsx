...
interface FreshPaymentOptionsSectionProps {
  paymentOptions: PaymentOption[];
  currentLang: Language;
}

const FreshPaymentOptionsSection: React.FC<FreshPaymentOptionsSectionProps> = ({
  paymentOptions,
  currentLang,
}) => {
  // Payment store hook
...
export default FreshPaymentOptionsSection;