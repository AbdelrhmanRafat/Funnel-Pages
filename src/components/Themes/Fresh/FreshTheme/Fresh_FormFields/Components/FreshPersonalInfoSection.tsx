...
interface FreshPersonalInfoSectionProps {
  cities: string[];
  currentLang: Language;
}

const FreshPersonalInfoSection: React.FC<FreshPersonalInfoSectionProps> = ({
  cities,
  currentLang,
}) => {
  // Form store hooks
    ...
    <>
      ...
      <div className="w-full">
        <div className='mb-3'>
          ...
          <h2
            className="fresh-form-h2-title mb-6 text-xl font-semibold md:text-2xl"
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="fresh-form-div-group">
              <input
                ...
                className={`fresh-form-input-base fresh-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  fullNameField.touched && fullNameField.errorMessage ? 'fresh-form-input-error' : 
                  fullNameField.touched && fullNameField.isValid ? 'fresh-form-input-success' : ''
                }`}
            ...
            <div className="fresh-form-div-group">
              <input
                ...
                className={`fresh-form-input-base fresh-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  phoneField.touched && phoneField.errorMessage ? 'fresh-form-input-error' : 
                  phoneField.touched && phoneField.isValid ? 'fresh-form-input-success' : ''
                }`}
            ...
            <div className="fresh-form-div-group">
              <input
                ...
                className={`fresh-form-input-base fresh-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  emailField.touched && emailField.errorMessage ? 'fresh-form-input-error' : 
                  emailField.touched && emailField.isValid ? 'fresh-form-input-success' : ''
                }`}
            ...
            <div className="fresh-form-div-group">
              <textarea
                ...
                className={`fresh-form-input-base fresh-form-textarea-responsive ${isArabic ? "text-right" : "text-left"} min-h-[80px] md:min-h-[100px] resize-y text-sm md:text-base ${
                  addressField.touched && addressField.errorMessage ? 'fresh-form-input-error' : 
                  addressField.touched && addressField.isValid ? 'fresh-form-input-success' : ''
                }`}
            ...
            <div className="fresh-form-div-group">
              <select 
                ...
                className={`fresh-form-select-base fresh-form-select-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  cityField.touched && cityField.errorMessage ? 'fresh-form-input-error' : 
                  cityField.touched && cityField.isValid ? 'fresh-form-input-success' : ''
                }`}
...
export default FreshPersonalInfoSection;