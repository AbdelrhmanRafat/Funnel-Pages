// FreshThemeHeader.ts - Simplified Header with Mobile Navigation
...
class FreshThemeHeader {
  ...
  private initializeElements(): HeaderElements {
    return {
      header: document.querySelector('.fresh-header') as HTMLElement | null,
      ...
      menuLinks: document.querySelectorAll('.fresh-menu-link')
    };
  }
