import "./FreshBundleOptionsContainer.css";
...
interface FreshBundleOptionsContainerReactProps {
  panelIndex: number;
  product: Product;
  currentLang: Language;
}

const FreshBundleOptionsContainerReact: React.FC<FreshBundleOptionsContainerReactProps> = ({
  panelIndex,
  product,
  currentLang,
}) => {
  ...
  return (
    <div className="fresh-bundle-options-container-panel p-4 border">
...
export default FreshBundleOptionsContainerReact;
