// FreshConfirmPurchaseButtonReact.tsx
import "./FreshConfirmPurchaseButton.css";
...
interface FreshConfirmPurchaseButtonReactProps {
  isArabic: boolean;
...
const FreshConfirmPurchaseButtonReact: React.FC<FreshConfirmPurchaseButtonReactProps> = ({
  disabled,
  isArabic,
  onClick,
  confirmTextOverride,
  ...
  return (
    <button
      type="button"
      className={`fresh-modal-confirm ${isLoading ? 'loading' : ''}`}
      onClick={handleClick}
      disabled={isLoading}
      aria-busy={isLoading}
    >
...
export default FreshConfirmPurchaseButtonReact;