...
interface FreshSelectionOptionsWithoutBundlesReactProps {
...
const FreshSelectionOptionsWithoutBundlesReact: React.FC<FreshSelectionOptionsWithoutBundlesReactProps> = ({
  isHaveVariant,
  hasSecondOption,
  processedOptionData,
  qtyNonVariant,
  ...
  return (
    <div className="fresh-selection-options-without-bundles w-full">
      <section id="fresh-selection-options-without-bundles-section">
...
export default FreshSelectionOptionsWithoutBundlesReact;
