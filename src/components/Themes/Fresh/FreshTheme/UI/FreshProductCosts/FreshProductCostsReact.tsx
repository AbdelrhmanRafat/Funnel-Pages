...
interface FreshProductCostsReactProps {
  hasBundles: boolean;
...
const FreshProductCostsReact: React.FC<FreshProductCostsReactProps> = ({
  hasBundles,
  ...
  return (
    <div className="fresh-product-costs-container">
...
export default FreshProductCostsReact;