...
import FreshThemeRatesReact from '../FreshThemeRates/FreshThemeRatesReact';

interface FreshProductHeaderReactProps {
  product: Product;
...
const FreshProductHeaderReact: React.FC<FreshProductHeaderReactProps> = ({
  product,
  purchaseOptions,
  isHaveVariant,
  currentLang,
    ...
    <div className="w-full flex flex-col justify-start items-start gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span
          className={`${
            product.is_active
              ? "fresh-product-details-badge-success text-xs py-1 px-3 rounded-full font-medium"
              : "fresh-product-details-badge-error text-xs py-1 px-3 rounded-full font-medium"
          }`}
          data-translate={
            product.is_active
              ? "product.available"
        ...
        {showSku && (
          <div className="fresh-product-details-sku text-sm">
      ...
      <div className="w-full flex justify-start items-center gap-4">
        <h2 className="fresh-product-details-title text-3xl lg:text-4xl font-bold leading-tight">
          {isArabic ? product.name_ar : product.name_en}
        </h2>
        {ratingData && (
          <FreshThemeRatesReact 
      ...
      <div className="flex justify-start items-center gap-4">
        ...
        <div className="fresh-product-details-price fresh-product-details-price--discount flex justify-center line-through items-center gap-2 text-4xl font-bold">
          <span data-product-price>{headerState.currentPrice}</span>
        </div>
        
        {/* Discounted Price */}
        <div className="fresh-product-details-price flex justify-center items-center gap-2 text-4xl font-bold">
...
export default FreshProductHeaderReact;