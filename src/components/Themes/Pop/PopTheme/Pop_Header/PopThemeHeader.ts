// PopThemeHeader.ts - Simplified Header with Mobile Navigation
...
class PopThemeHeader {
  ...
  private initializeElements(): HeaderElements {
    return {
      header: document.querySelector('.pop-header') as HTMLElement | null,
      ...
      menuLinks: document.querySelectorAll('.pop-menu-link')
    };
  }
