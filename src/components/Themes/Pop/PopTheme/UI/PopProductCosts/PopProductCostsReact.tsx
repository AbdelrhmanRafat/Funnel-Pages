...
interface PopProductCostsReactProps {
  hasBundles: boolean;
...
const PopProductCostsReact: React.FC<PopProductCostsReactProps> = ({
  hasBundles,
  ...
  return (
    <div className="pop-product-costs-container">
...
export default PopProductCostsReact;