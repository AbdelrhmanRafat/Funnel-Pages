...
import PopThemeRatesReact from '../PopThemeRates/PopThemeRatesReact';

interface PopProductHeaderReactProps {
  product: Product;
...
const PopProductHeaderReact: React.FC<PopProductHeaderReactProps> = ({
  product,
  purchaseOptions,
  isHaveVariant,
  currentLang,
  ...
  return (
    <div className="w-full flex flex-col justify-start items-start gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        {showSku && (
          <div className="pop-product-details-sku text-sm">
      ...
      <div className="w-full flex justify-start items-center gap-4">
        <h2 className="pop-product-details-title text-3xl lg:text-4xl font-bold leading-tight">
      ...
      <div className="flex justify-start items-center gap-4">
        ...
        <div className="pop-product-details-price pop-product-details-price--discount flex justify-center line-through items-center gap-2 text-4xl font-bold">
          <span data-product-price>{headerState.currentPrice}</span>
        </div>
        
        {/* Discounted Price */}
        <div className="pop-product-details-price flex justify-center items-center gap-2 text-4xl font-bold">
...
export default PopProductHeaderReact;