// TechnoThemeHeader.ts - Simplified Header with Mobile Navigation
...
class TechnoThemeHeader {
  ...
  private initializeElements(): HeaderElements {
    return {
      header: document.querySelector('.techno-header') as HTMLElement | null,
      ...
      menuLinks: document.querySelectorAll('.techno-menu-link')
    };
  }
