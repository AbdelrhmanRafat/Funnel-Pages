...
import './TechnoThemeRates.css';

interface TechnoThemeRatesReactProps {
...
const TechnoThemeRatesReact: React.FC<TechnoThemeRatesReactProps> = ({
  ratingData,
  currentLang,
}) => {
  ...
  const StarIcon: React.FC<{ star: Star }> = ({ star }) => {
    ...
    switch (star.type) {
      case 'full':
        return (
          <svg className="techno-rating-star-full" {...baseProps}>
      ...
      case 'half':
        return (
          <svg className="techno-rating-star-half" {...baseProps}>
            <defs>
              <linearGradient id="halfGradient">
                <stop offset="50%" stopColor="currentColor" />
                <stop offset="50%" stopColor="var(--techno-color-outline)" />
              </linearGradient>
            </defs>
      ...
      case 'empty':
        return (
          <svg className="techno-rating-star-empty" {...baseProps}>
            <path d={starPath} fill="currentColor" />
          </svg>
        );
  ...
  return (
    <div id={FunnelTechnoComponents.TechnoRates} className="techno-rates">
      <div
        className="techno-rating-display"
      ...
      >
        ...
        <span className="techno-rating-number">({rating})</span>
      </div>
    </div>
  );
};

export default TechnoThemeRatesReact;