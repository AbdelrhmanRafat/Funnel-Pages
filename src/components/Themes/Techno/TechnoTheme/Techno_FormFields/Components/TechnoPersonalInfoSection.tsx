...
interface TechnoPersonalInfoSectionProps {
  cities: string[];
  currentLang: Language;
}

const TechnoPersonalInfoSection: React.FC<TechnoPersonalInfoSectionProps> = ({
  cities,
  currentLang,
}) => {
  // Form store hooks
    ...
    <>
      ...
      <div className="w-full">
        <div className='mb-3'>
          ...
          <h2
            className="techno-form-h2-title mb-6 text-xl font-semibold md:text-2xl"
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="techno-form-div-group">
              <input
                type="text"
                id="form-fullName"
                ...
                className={`techno-form-input-base techno-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  fullNameField.touched && fullNameField.errorMessage ? 'techno-form-input-error' : 
                  fullNameField.touched && fullNameField.isValid ? 'techno-form-input-success' : ''
                }`}
              ...
              <label
                ...
                className="techno-form-label-floating"
              ...
              <span
                ...
                className="techno-form-span-error text-xs md:text-sm"
                role="alert"
            ...
            <div className="techno-form-div-group">
              <input
                ...
                className={`techno-form-input-base techno-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  phoneField.touched && phoneField.errorMessage ? 'techno-form-input-error' : 
                  phoneField.touched && phoneField.isValid ? 'techno-form-input-success' : ''
                }`}
            ...
            <div className="techno-form-div-group">
              <input
                ...
                className={`techno-form-input-base techno-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  emailField.touched && emailField.errorMessage ? 'techno-form-input-error' : 
                  emailField.touched && emailField.isValid ? 'techno-form-input-success' : ''
                }`}
            ...
            <div className="techno-form-div-group">
              <textarea
                ...
                className={`techno-form-input-base techno-form-textarea-responsive ${isArabic ? "text-right" : "text-left"} min-h-[80px] md:min-h-[100px] resize-y text-sm md:text-base ${
                  addressField.touched && addressField.errorMessage ? 'techno-form-input-error' : 
                  addressField.touched && addressField.isValid ? 'techno-form-input-success' : ''
                }`}
            ...
            <div className="techno-form-div-group">
              <select 
                ...
                className={`techno-form-select-base techno-form-select-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  cityField.touched && cityField.errorMessage ? 'techno-form-input-error' : 
                  cityField.touched && cityField.isValid ? 'techno-form-input-success' : ''
                }`}
...
export default TechnoPersonalInfoSection;