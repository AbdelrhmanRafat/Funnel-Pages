...
interface TechnoPaymentOptionsSectionProps {
  paymentOptions: PaymentOption[];
  currentLang: Language;
}

const TechnoPaymentOptionsSection: React.FC<TechnoPaymentOptionsSectionProps> = ({
  paymentOptions,
  currentLang,
}) => {
  // Payment store hook
...
export default TechnoPaymentOptionsSection;