...
interface TechnoSelectionOptionsWithoutBundlesReactProps {
...
const TechnoSelectionOptionsWithoutBundlesReact: React.FC<TechnoSelectionOptionsWithoutBundlesReactProps> = ({
  isHaveVariant,
  hasSecondOption,
  processedOptionData,
  qtyNonVariant,
  ...
  return (
    <div className="techno-selection-options-without-bundles w-full">
      <section id="techno-selection-options-without-bundles-section">
...
export default TechnoSelectionOptionsWithoutBundlesReact;
