...
interface ClassicDeliveryOptionsSectionProps {
  deliveryOptions: DeliveryOption[];
  currentLang: Language;
}

const ClassicDeliveryOptionsSection: React.FC<ClassicDeliveryOptionsSectionProps> = ({
  deliveryOptions,
  currentLang,
}) => {
  // Delivery store hook
...
export default ClassicDeliveryOptionsSection;