// NeonThemeHeader.ts - Simplified Header with Mobile Navigation
...
class NeonThemeHeader {
  ...
  private initializeElements(): HeaderElements {
    return {
      header: document.querySelector('.neon-header') as HTMLElement | null,
      ...
      menuLinks: document.querySelectorAll('.neon-menu-link')
    };
  }
