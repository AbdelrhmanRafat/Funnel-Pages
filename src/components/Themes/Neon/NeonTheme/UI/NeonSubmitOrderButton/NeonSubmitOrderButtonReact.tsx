import "./NeonSubmitOrderButton.css";
import React, { useState } from 'react';
import type { Language } from '../../../../../../lib/utils/i18n/translations';
import type { BlockData, Product } from '../../../../../../lib/api/types';
import NeonModalPurchaseInfoReact from '../../NeonModalPurchaseInfo/NeonModalPurchaseInfoReact';
...
interface NeonSubmitOrderButtonReactProps {
...
const NeonSubmitOrderButtonReact: React.FC<NeonSubmitOrderButtonReactProps> = ({
  product,
  purchaseOptions,
  isHaveVariant,
  currentLang = "en",
  ...
  return (
    <>
      <div className="neon-form-submit-wrapper">
...
export default NeonSubmitOrderButtonReact;