...
const NeonTextOptionsWithoutBundlesReact: React.FC<NeonTextOptionsWithoutBundlesReactProps> = ({
  ...
  const baseClasses = "neon-selection-options-without-bundles-size-option py-2 px-3 sm:py-2.5 sm:px-5 border rounded-lg sm:rounded-xl cursor-pointer text-xs sm:text-sm font-medium text-center transition-all duration-200";
  
  // Apply selection styles
  const selectedClass = isSelected ? "neon-selection-options-without-bundles-size-option--selected" : "";
