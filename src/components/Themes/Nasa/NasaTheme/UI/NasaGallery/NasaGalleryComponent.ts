// nasaGalleryController.ts
export class nasaGalleryController {
    ...
    constructor(galleryId: string = 'nasa-gallery') {
        this.init(galleryId);
    }
    ...
    private setupGallery(galleryId: string): void {
        ...
        this.thumbnails = this.gallery.querySelectorAll('.nasa-thumbnail');
...
let galleryController: nasaGalleryController;

// Auto-initialize
document.addEventListener('DOMContentLoaded', () => {
    galleryController = new nasaGalleryController();
