...
interface BoldPersonalInfoSectionProps {
  cities: string[];
  currentLang: Language;
}

const BoldPersonalInfoSection: React.FC<BoldPersonalInfoSectionProps> = ({
  cities,
  currentLang,
}) => {
  // Form store hooks
    ...
    <>
      ...
      <div className="w-full">
        <div className='mb-3'>
          ...
          <h2
            className="bold-form-h2-title mb-6 text-xl font-semibold md:text-2xl"
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="bold-form-div-group">
              <input
                ...
                className={`bold-form-input-base bold-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  fullNameField.touched && fullNameField.errorMessage ? 'bold-form-input-error' : 
                  fullNameField.touched && fullNameField.isValid ? 'bold-form-input-success' : ''
                }`}
            ...
            <div className="bold-form-div-group">
              <input
                ...
                className={`bold-form-input-base bold-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  phoneField.touched && phoneField.errorMessage ? 'bold-form-input-error' : 
                  phoneField.touched && phoneField.isValid ? 'bold-form-input-success' : ''
                }`}
            ...
            <div className="bold-form-div-group">
              <input
                ...
                className={`bold-form-input-base bold-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  emailField.touched && emailField.errorMessage ? 'bold-form-input-error' : 
                  emailField.touched && emailField.isValid ? 'bold-form-input-success' : ''
                }`}
            ...
            <div className="bold-form-div-group">
              <textarea
                ...
                className={`bold-form-input-base bold-form-textarea-responsive ${isArabic ? "text-right" : "text-left"} min-h-[80px] md:min-h-[100px] resize-y text-sm md:text-base ${
                  addressField.touched && addressField.errorMessage ? 'bold-form-input-error' : 
                  addressField.touched && addressField.isValid ? 'bold-form-input-success' : ''
                }`}
            ...
            <div className="bold-form-div-group">
              <select 
                ...
                className={`bold-form-select-base bold-form-select-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  cityField.touched && cityField.errorMessage ? 'bold-form-input-error' : 
                  cityField.touched && cityField.isValid ? 'bold-form-input-success' : ''
                }`}
...
export default BoldPersonalInfoSection;