...
interface BoldPaymentOptionsSectionProps {
  paymentOptions: PaymentOption[];
  currentLang: Language;
}

const BoldPaymentOptionsSection: React.FC<BoldPaymentOptionsSectionProps> = ({
  paymentOptions,
  currentLang,
}) => {
  // Payment store hook
...
export default BoldPaymentOptionsSection;