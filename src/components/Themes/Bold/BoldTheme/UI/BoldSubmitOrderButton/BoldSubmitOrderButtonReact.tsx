import "./BoldSubmitOrderButton.css";
import React, { useState } from 'react';
import type { Language } from '../../../../../../lib/utils/i18n/translations';
import type { BlockData, Product } from '../../../../../../lib/api/types';
import BoldModalPurchaseInfoReact from '../../BoldModalPurchaseInfo/BoldModalPurchaseInfoReact';
...
interface BoldSubmitOrderButtonReactProps {
...
const BoldSubmitOrderButtonReact: React.FC<BoldSubmitOrderButtonReactProps> = ({
  product,
  purchaseOptions,
  isHaveVariant,
  currentLang = "en",
  ...
  return (
    <>
      <div className="bold-form-submit-wrapper">
...
export default BoldSubmitOrderButtonReact;