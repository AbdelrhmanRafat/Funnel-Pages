import "./BoldModalPurchaseInfo.css";
...
interface BoldModalPurchaseInfoReactProps {
  product: Product;
  isArabic: boolean;
...
const BoldModalPurchaseInfoReact: React.FC<BoldModalPurchaseInfoReactProps> = ({
  product,
  isArabic,
  currentLang,
  hasVariants,
  ...
  return (
    ...
    >
      {/* Overlay */}
      <div 
        className="bold-modal-div-overlay absolute inset-0 z-[1001] transition-opacity duration-300" 
        onClick={handleClose}
        aria-hidden="true"
      />
      ...
      <div className="relative container md:w-10/12 lg:w-8/12 xl:w-6/12 max-h-[95vh] overflow-y-auto z-[1002] m-4 transition-all duration-300 transform">
        <div className="bold-modal-div-invoice rounded-xl">
...
export default BoldModalPurchaseInfoReact;