// TroyThemeHeader.ts - Simplified Header with Mobile Navigation
...
class TroyThemeHeader {
  ...
  private initializeElements(): HeaderElements {
    return {
      header: document.querySelector('.troy-header') as HTMLElement | null,
      ...
      menuLinks: document.querySelectorAll('.troy-menu-link')
    };
  }
