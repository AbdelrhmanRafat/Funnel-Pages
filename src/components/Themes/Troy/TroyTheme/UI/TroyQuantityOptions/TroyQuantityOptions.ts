// troyQuantityOptions.ts - Web Component for Offer Selection
...
class OfferSelector extends HTMLElement {
  ...
  private updateRepeatedElementsVisibility(selectedRadio: HTMLInputElement): void {
    ...
    if (targetRepeatedElements) {
      ...
      // Find all troy dynamic panel containers and reset them
      const dynamicPanels = targetRepeatedElements.querySelectorAll('troy-select-options');
