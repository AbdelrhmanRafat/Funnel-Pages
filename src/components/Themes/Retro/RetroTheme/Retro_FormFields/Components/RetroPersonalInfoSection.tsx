...
interface RetroPersonalInfoSectionProps {
  cities: string[];
  currentLang: Language;
}

const RetroPersonalInfoSection: React.FC<RetroPersonalInfoSectionProps> = ({
  cities,
  currentLang,
}) => {
  // Form store hooks
    ...
    <>
      ...
      <div className="w-full">
        <div className='mb-3'>
          ...
          <h2
            className="retro-form-h2-title mb-6 text-xl font-semibold md:text-2xl"
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="retro-form-div-group">
              <input
                type="text"
                id="form-fullName"
                ...
                className={`retro-form-input-base retro-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  fullNameField.touched && fullNameField.errorMessage ? 'retro-form-input-error' : 
                  fullNameField.touched && fullNameField.isValid ? 'retro-form-input-success' : ''
                }`}
              ...
              <label
                ...
                className="retro-form-label-floating"
              ...
              <span
                ...
                className="retro-form-span-error text-xs md:text-sm"
                role="alert"
            ...
            <div className="retro-form-div-group">
              <input
                ...
                className={`retro-form-input-base retro-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  phoneField.touched && phoneField.errorMessage ? 'retro-form-input-error' : 
                  phoneField.touched && phoneField.isValid ? 'retro-form-input-success' : ''
                }`}
            ...
            <div className="retro-form-div-group">
              <input
                ...
                className={`retro-form-input-base retro-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  emailField.touched && emailField.errorMessage ? 'retro-form-input-error' : 
                  emailField.touched && emailField.isValid ? 'retro-form-input-success' : ''
                }`}
            ...
            <div className="retro-form-div-group">
              <textarea
                ...
                className={`retro-form-input-base retro-form-textarea-responsive ${isArabic ? "text-right" : "text-left"} min-h-[80px] md:min-h-[100px] resize-y text-sm md:text-base ${
                  addressField.touched && addressField.errorMessage ? 'retro-form-input-error' : 
                  addressField.touched && addressField.isValid ? 'retro-form-input-success' : ''
                }`}
            ...
            <div className="retro-form-div-group">
              <select 
                ...
                className={`retro-form-select-base retro-form-select-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  cityField.touched && cityField.errorMessage ? 'retro-form-input-error' : 
                  cityField.touched && cityField.isValid ? 'retro-form-input-success' : ''
                }`}
...
export default RetroPersonalInfoSection;