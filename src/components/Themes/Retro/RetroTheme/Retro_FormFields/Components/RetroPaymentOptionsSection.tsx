...
interface RetroPaymentOptionsSectionProps {
  paymentOptions: PaymentOption[];
  currentLang: Language;
}

const RetroPaymentOptionsSection: React.FC<RetroPaymentOptionsSectionProps> = ({
  paymentOptions,
  currentLang,
}) => {
  // Payment store hook
...
export default RetroPaymentOptionsSection;