...
interface RetroNotesSectionProps {
  currentLang: Language;
}

const RetroNotesSection: React.FC<RetroNotesSectionProps> = ({
  currentLang,
}) => {
  // Form store hooks
  const {
  ...
  return (
    <div className="retro-form-div-notes">
      <div className="retro-form-div-group">
        <textarea
          ...
          placeholder=""
          className={`retro-form-input-base retro-form-textarea-responsive ${isArabic ? "text-right" : "text-left"} min-h-[100px] md:min-h-[120px] resize-y text-sm md:text-base ${
            notesField.touched && notesField.errorMessage ? 'retro-form-input-error' : 
            notesField.touched && notesField.isValid ? 'retro-form-input-success' : ''
          }`}
...
export default RetroNotesSection;