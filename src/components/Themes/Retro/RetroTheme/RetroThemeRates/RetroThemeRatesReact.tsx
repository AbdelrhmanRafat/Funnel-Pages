...
import './RetroThemeRates.css';

interface RetroThemeRatesReactProps {
...
const RetroThemeRatesReact: React.FC<RetroThemeRatesReactProps> = ({
  ratingData,
  currentLang,
}) => {
  ...
  const StarIcon: React.FC<{ star: Star }> = ({ star }) => {
    ...
    switch (star.type) {
      case 'full':
        return (
          <svg className="retro-rating-star-full" {...baseProps}>
      ...
      case 'half':
        return (
          <svg className="retro-rating-star-half" {...baseProps}>
            <defs>
              <linearGradient id="halfGradient">
                <stop offset="50%" stopColor="currentColor" />
                <stop offset="50%" stopColor="var(--retro-color-outline)" />
              </linearGradient>
            </defs>
      ...
      case 'empty':
        return (
          <svg className="retro-rating-star-empty" {...baseProps}>
            <path d={starPath} fill="currentColor" />
          </svg>
        );
  ...
  return (
    <div id={FunnelRetroComponents.RetroRates} className="retro-rates">
      <div
        className="retro-rating-display"
      ...
      >
        ...
        <span className="retro-rating-number">({rating})</span>
      </div>
    </div>
  );
};

export default RetroThemeRatesReact;