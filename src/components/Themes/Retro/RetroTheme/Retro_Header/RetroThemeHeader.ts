// RetroThemeHeader.ts - Simplified Header with Mobile Navigation
...
class RetroThemeHeader {
  ...
  private initializeElements(): HeaderElements {
    return {
      header: document.querySelector('.retro-header') as HTMLElement | null,
      ...
      menuLinks: document.querySelectorAll('.retro-menu-link')
    };
  }
