import "./RetroBundleOptionsContainer.css";
...
interface RetroBundleOptionsContainerReactProps {
  panelIndex: number;
  product: Product;
  currentLang: Language;
}

const RetroBundleOptionsContainerReact: React.FC<RetroBundleOptionsContainerReactProps> = ({
  panelIndex,
  product,
  currentLang,
}) => {
  ...
  return (
    <div className="retro-bundle-options-container-panel p-4 border">
...
export default RetroBundleOptionsContainerReact;
