...
interface RetroProductCostsReactProps {
  hasBundles: boolean;
...
const RetroProductCostsReact: React.FC<RetroProductCostsReactProps> = ({
  hasBundles,
  ...
  return (
    <div className="retro-product-costs-container">
...
export default RetroProductCostsReact;