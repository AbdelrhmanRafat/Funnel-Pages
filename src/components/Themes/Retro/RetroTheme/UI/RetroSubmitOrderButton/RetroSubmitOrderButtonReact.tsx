import "./RetroSubmitOrderButton.css";
import React, { useState } from 'react';
import type { Language } from '../../../../../../lib/utils/i18n/translations';
import type { BlockData, Product } from '../../../../../../lib/api/types';
import RetroModalPurchaseInfoReact from '../../RetroModalPurchaseInfo/RetroModalPurchaseInfoReact';
...
interface RetroSubmitOrderButtonReactProps {
...
const RetroSubmitOrderButtonReact: React.FC<RetroSubmitOrderButtonReactProps> = ({
  product,
  purchaseOptions,
  isHaveVariant,
  currentLang = "en",
  ...
  return (
    <>
      <div className="retro-form-submit-wrapper">
...
export default RetroSubmitOrderButtonReact;