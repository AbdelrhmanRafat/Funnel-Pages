...
interface RetroSelectionOptionsWithoutBundlesReactProps {
...
const RetroSelectionOptionsWithoutBundlesReact: React.FC<RetroSelectionOptionsWithoutBundlesReactProps> = ({
  isHaveVariant,
  hasSecondOption,
  processedOptionData,
  qtyNonVariant,
  ...
  return (
    <div className="retro-selection-options-without-bundles w-full">
      <section id="retro-selection-options-without-bundles-section">
...
export default RetroSelectionOptionsWithoutBundlesReact;
