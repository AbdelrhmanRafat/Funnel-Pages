// RetroConfirmPurchaseButtonReact.tsx
import "./RetroConfirmPurchaseButton.css";
...
interface RetroConfirmPurchaseButtonReactProps {
  isArabic: boolean;
...
const RetroConfirmPurchaseButtonReact: React.FC<RetroConfirmPurchaseButtonReactProps> = ({
  disabled,
  isArabic,
  onClick,
  confirmTextOverride,
  ...
  return (
    <button
      type="button"
      className={`retro-modal-confirm ${isLoading ? 'loading' : ''}`}
      onClick={handleClick}
      disabled={isLoading}
      aria-busy={isLoading}
    >
...
export default RetroConfirmPurchaseButtonReact;