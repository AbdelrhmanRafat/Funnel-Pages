...
import RetroThemeRatesReact from '../RetroThemeRates/RetroThemeRatesReact';

interface RetroProductHeaderReactProps {
  product: Product;
...
const RetroProductHeaderReact: React.FC<RetroProductHeaderReactProps> = ({
  product,
  purchaseOptions,
  isHaveVariant,
  currentLang,
    ...
    <div className="w-full flex flex-col justify-start items-start gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span
          className={`${
            product.is_active
              ? "retro-product-details-badge-success text-xs py-1 px-3 rounded-full font-medium"
              : "retro-product-details-badge-error text-xs py-1 px-3 rounded-full font-medium"
          }`}
          data-translate={
            product.is_active
              ? "product.available"
        ...
        {showSku && (
          <div className="retro-product-details-sku text-sm">
      ...
      <div className="w-full flex justify-start items-center gap-4">
        <h2 className="retro-product-details-title text-3xl lg:text-4xl font-bold leading-tight">
          {isArabic ? product.name_ar : product.name_en}
        </h2>
        {ratingData && (
          <RetroThemeRatesReact 
      ...
      <div className="flex justify-start items-center gap-4">
        ...
        <div className="retro-product-details-price retro-product-details-price--discount flex justify-center line-through items-center gap-2 text-4xl font-bold">
          <span data-product-price>{headerState.currentPrice}</span>
        </div>
        
        {/* Discounted Price */}
        <div className="retro-product-details-price flex justify-center items-center gap-2 text-4xl font-bold">
...
export default RetroProductHeaderReact;