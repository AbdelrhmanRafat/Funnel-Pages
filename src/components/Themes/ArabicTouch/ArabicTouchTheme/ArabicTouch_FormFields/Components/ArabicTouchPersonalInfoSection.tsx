...
interface ArabicTouchPersonalInfoSectionProps {
  cities: string[];
  currentLang: Language;
}

const ArabicTouchPersonalInfoSection: React.FC<ArabicTouchPersonalInfoSectionProps> = ({
  cities,
  currentLang,
}) => {
  // Form store hooks
    ...
    <>
      ...
      <div className="w-full">
        <div className='mb-3'>
          ...
          <h2
            className="arabictouch-form-h2-title mb-6 text-xl font-semibold md:text-2xl"
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="arabictouch-form-div-group">
              <input
                type="text"
                id="form-fullName"
                ...
                className={`arabictouch-form-input-base arabictouch-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  fullNameField.touched && fullNameField.errorMessage ? 'arabictouch-form-input-error' : 
                  fullNameField.touched && fullNameField.isValid ? 'arabictouch-form-input-success' : ''
                }`}
              ...
              <label
                ...
                className="arabictouch-form-label-floating"
            ...
            <div className="arabictouch-form-div-group">
              <input
                ...
                className={`arabictouch-form-input-base arabictouch-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  phoneField.touched && phoneField.errorMessage ? 'arabictouch-form-input-error' : 
                  phoneField.touched && phoneField.isValid ? 'arabictouch-form-input-success' : ''
                }`}
            ...
            <div className="arabictouch-form-div-group">
              <input
                ...
                className={`arabictouch-form-input-base arabictouch-form-input-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  emailField.touched && emailField.errorMessage ? 'arabictouch-form-input-error' : 
                  emailField.touched && emailField.isValid ? 'arabictouch-form-input-success' : ''
                }`}
            ...
            <div className="arabictouch-form-div-group">
              <textarea
                ...
                className={`arabictouch-form-input-base arabictouch-form-textarea-responsive ${isArabic ? "text-right" : "text-left"} min-h-[80px] md:min-h-[100px] resize-y text-sm md:text-base ${
                  addressField.touched && addressField.errorMessage ? 'arabictouch-form-input-error' : 
                  addressField.touched && addressField.isValid ? 'arabictouch-form-input-success' : ''
                }`}
            ...
            <div className="arabictouch-form-div-group">
              <select 
                ...
                className={`arabictouch-form-select-base arabictouch-form-select-responsive ${isArabic ? "text-right" : "text-left"} text-sm md:text-base ${
                  cityField.touched && cityField.errorMessage ? 'arabictouch-form-input-error' : 
                  cityField.touched && cityField.isValid ? 'arabictouch-form-input-success' : ''
                }`}
...
export default ArabicTouchPersonalInfoSection;