...
interface ArabicTouchPaymentOptionsSectionProps {
  paymentOptions: PaymentOption[];
  currentLang: Language;
}

const ArabicTouchPaymentOptionsSection: React.FC<ArabicTouchPaymentOptionsSectionProps> = ({
  paymentOptions,
  currentLang,
}) => {
  // Payment store hook
...
export default ArabicTouchPaymentOptionsSection;