...
interface ArabicTouchNotesSectionProps {
  currentLang: Language;
}

const ArabicTouchNotesSection: React.FC<ArabicTouchNotesSectionProps> = ({
  currentLang,
}) => {
  // Form store hooks
  const {
  ...
  return (
    <div className="arabictouch-form-div-notes">
      <div className="arabictouch-form-div-group">
        <textarea
          ...
          placeholder=""
          className={`arabictouch-form-input-base arabictouch-form-textarea-responsive ${isArabic ? "text-right" : "text-left"} min-h-[100px] md:min-h-[120px] resize-y text-sm md:text-base ${
            notesField.touched && notesField.errorMessage ? 'arabictouch-form-input-error' : 
            notesField.touched && notesField.isValid ? 'arabictouch-form-input-success' : ''
          }`}
...
export default ArabicTouchNotesSection;