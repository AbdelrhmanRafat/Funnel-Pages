 ...
 */
class ArabicTouchFormFieldsHandler {
  ...
  private updateUI(fieldId: string, message: string, isValid: boolean): void {
    ...
    if (errorElement) {
      ...
      errorElement.className = `arabictouch-form-error ${isValid ? 'arabictouch-text-success' : 'arabictouch-text-error'}`;
    }
...
document.addEventListener('DOMContentLoaded', () => {
  new ArabicTouchFormFieldsHandler();
