// ArabicTouchCoupon.ts - Simple web component for coupon copying

class ArabicTouchCoupon extends HTMLElement {
    connectedCallback() {
...
customElements.define('arabictouch-coupon', ArabicTouchCoupon);