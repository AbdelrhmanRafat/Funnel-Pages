...
const SubmitButton: React.FC<SubmitButtonProps> = ({
  ...
  return (
    <button
      ...
      className={`arabictouch-submit-button-button-base text-sm px-6 py-3 md:text-base md:px-8 md:py-4 ${
        isValidating ? 'arabictouch-submit-button-button-validating' : ''
      }`}
      onClick={onClick}
      disabled={disabled}
