// ArabicTouchConfirmPurchaseButtonReact.tsx
import "./ArabicTouchConfirmPurchaseButton.css";
...
interface ArabicTouchConfirmPurchaseButtonReactProps {
  isArabic: boolean;
...
const ArabicTouchConfirmPurchaseButtonReact: React.FC<ArabicTouchConfirmPurchaseButtonReactProps> = ({
  disabled,
  isArabic,
  onClick,
  confirmTextOverride,
  ...
  return (
    <button
      type="button"
      className={`arabictouch-modal-confirm ${isLoading ? 'loading' : ''}`}
      onClick={handleClick}
      disabled={isLoading}
      aria-busy={isLoading}
    >
...
export default ArabicTouchConfirmPurchaseButtonReact;