// ArabicTouchSelectionOptionsWithoutBundles.ts - Production Ready Component
...
const CSS_CLASSES = {
  SELECTED_COLOR: 'arabictouch-selection-options-without-bundles-color-option--selected',
  SELECTED_SIZE: 'arabictouch-selection-options-without-bundles-size-option--selected',
  SELECTED_GENERIC: 'arabictouch-selection-options-without-bundles-selected',
  COLOR_OPTION: 'arabictouch-selection-options-without-bundles-color-option',
  SIZE_OPTION: 'arabictouch-selection-options-without-bundles-size-option',
  OPTION_AVAILABLE: 'arabictouch-selection-options-without-bundles-option-available',
  OPTION_DISABLED: 'arabictouch-selection-options-without-bundles-option-disabled'
} as const;

class ArabicTouchSelectOptions extends HTMLElement implements Observer<CustomOptionsNonBundleState> {
  ...
  private initializeSettings(): void {
    try {
      ...
      console.error('ArabicTouchSelectOptions: Failed to initialize settings:', error);
    }
  }
  ...
  public update(subject: Subject<CustomOptionsNonBundleState>): void {
    try {
      ...
      console.error('ArabicTouchSelectOptions: Observer update failed:', error);
    }
  }
  ...
  private handleFirstOptionClick(element: HTMLElement): void {
    ...
    try {
      ...
      console.error('ArabicTouchSelectOptions: First option selection failed:', error);
    }
  }
  ...
  private handleSecondOptionClick(element: HTMLElement): void {
    ...
    try {
      ...
      console.error('ArabicTouchSelectOptions: Second option selection failed:', error);
    }
  }
  ...
  private handleQuantityDecrease(): void {
    try {
      ...
      console.error('ArabicTouchSelectOptions: Quantity decrease failed:', error);
    }
  }
  ...
  private handleQuantityIncrease(): void {
    try {
      ...
      console.error('ArabicTouchSelectOptions: Quantity increase failed:', error);
    }
  }
  ...
  private handleQuantityInput(): void {
    ...
    try {
      ...
      console.error('ArabicTouchSelectOptions: Quantity input failed:', error);
    }
  }
  ...
  private validateQuantityInput(): void {
    ...
    try {
      ...
      console.error('ArabicTouchSelectOptions: Quantity validation failed:', error);
    }
  }
  ...
  private applySelectionStyle(element: HTMLElement): void {
    try {
      ...
      console.error('ArabicTouchSelectOptions: Failed to apply selection style:', error);
    }
  }
  ...
  private safeFilterSecondOptions(firstValue: string): void {
    ...
    try {
      ...
      console.error('ArabicTouchSelectOptions: Failed to filter second options:', error);
    }
  }
  ...
  private toggleElementAvailability(element: HTMLElement, isAvailable: boolean): void {
    try {
      ...
      console.error('ArabicTouchSelectOptions: Failed to toggle element availability:', error);
    }
  }
  ...
  private updateVisualSelections(option: any): void {
    try {
      ...
      console.error('ArabicTouchSelectOptions: Failed to update visual selections:', error);
    }
  }
  ...
  private updateAvailableOptions(state: CustomOptionsNonBundleState): void {
    ...
    try {
      ...
      console.error('ArabicTouchSelectOptions: Failed to update available options:', error);
    }
  }
  ...
  private updateQuantityControls(currentQty: number, maxQty: number): void {
    try {
      ...
      console.error('ArabicTouchSelectOptions: Failed to update quantity controls:', error);
    }
  }
  ...
  private updateMaxQuantityDisplay(maxQty: number, isSelectionComplete: boolean): void {
    try {
      ...
      console.error('ArabicTouchSelectOptions: Failed to update max quantity display:', error);
    }
  }
  ...
  public getSelectedOptions(): { first: string | null; second: string | null } {
    try {
      ...
      console.error('ArabicTouchSelectOptions: Failed to get selected options:', error);
  ...
  public isSelectionComplete(): boolean {
    try {
      ...
      console.error('ArabicTouchSelectOptions: Failed to check selection completion:', error);
      return false;
    }
  }
  ...
  public clearSelections(): void {
    try {
      ...
      console.error('ArabicTouchSelectOptions: Failed to clear selections:', error);
    }
  }
  ...
  private resetSecondOptionsState(): void {
    ...
    try {
      ...
      console.error('ArabicTouchSelectOptions: Failed to reset second options state:', error);
    }
  }
}

// Component Registration
class ArabicTouchSelectOptionsManager {
  private static readonly COMPONENT_NAME = 'arabictouch-select-options';
  ...
  private static registerComponent(): void {
    if (!customElements.get(this.COMPONENT_NAME)) {
      customElements.define(this.COMPONENT_NAME, ArabicTouchSelectOptions);
    }
  }
  ...
  private static handleAstroPageLoad(): void {
    ...
    undefinedComponents.forEach(component => {
      if (component instanceof ArabicTouchSelectOptions) {
...
ArabicTouchSelectOptionsManager.initialize();

export { ArabicTouchSelectOptions };