...
interface ArabicTouchSelectionOptionsWithoutBundlesReactProps {
...
const ArabicTouchSelectionOptionsWithoutBundlesReact: React.FC<ArabicTouchSelectionOptionsWithoutBundlesReactProps> = ({
  ...
  return (
    <div className="arabictouch-selection-options-without-bundles w-full">
...
export default ArabicTouchSelectionOptionsWithoutBundlesReact;
