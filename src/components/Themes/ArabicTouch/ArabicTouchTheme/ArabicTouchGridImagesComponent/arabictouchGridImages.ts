class ArabicTouchFadeInGallery extends HTMLElement {
...
customElements.define('arabictouch-fade-in-gallery', ArabicTouchFadeInGallery);

// Export for TypeScript modules
export default ArabicTouchFadeInGallery;